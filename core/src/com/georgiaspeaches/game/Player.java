...
public class Player extends ApplicationAdapter{
	...
	public void create() {
		...
		img = new Texture("core/assets/player.png");
		...
		// you also define it's properties like density, restitution and otherswe will see shortly
		// If you are wondering, density and area are used to calculate over allmass
